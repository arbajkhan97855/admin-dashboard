...
export function UpdateAgent() {
  ...
  async function fetchdata() {
    try {
     ...
     setformdata({
      ...json[0],
      IsFlight: json[0].IsFlight === "true" || json[0].IsFlight === true,
      IsHotel: json[0].IsHotel === "true" || json[0].IsHotel === true,
      IsHotelFlight: json[0].IsHotelFlight === "true" || json[0].IsHotelFlight === true,
      IsVisa: json[0].IsVisa === "true" || json[0].IsVisa === true,
      IsCarRental: json[0].IsCarRental === "true" || json[0].IsCarRental === true,
    });
    } catch (error) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (apiurl.ok) {
        toast.success(res.message || "Agency Update Done");
        setTimeout(() => {
          usenavigate("/agent")
        },1000);
      } else {
        ...
        >
          ...
          <div className="row">
            <div className="col">
              ...
              {formdata.Logo && (
                <img
                  src={`http://localhost:4000/upload/${formdata.Logo}`}
                  alt="Logo"
                  style={{
                    width: "120px",
                    marginBottom: "10px",
          ...
          <div className="row">
            <div className="col">
              ...
              {formdata.License && (
                <img
                  src={`http://localhost:4000/upload/${formdata.License}`}
                  alt="License"
                  style={{
                    width: "120px",
                    marginBottom: "10px",
            ...
            <div className="col">
              ...
              {formdata.ID_Proof && (
                <img
                  src={`http://localhost:4000/upload/${formdata.ID_Proof}`}
                  alt="ID_Proof"
                  style={{
                    width: "120px",
                    marginBottom: "10px",
