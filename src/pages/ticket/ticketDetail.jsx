...
export function TicketDetail() {
  ...
  const handleChatSubmit = async () => {
    try {
      ...
      formData.append("sender_name", "Arbaj Khan");
  ...
  return (
    <>
      ...
      <main className="main">
        ...
        {/* USER REPLY */}
        {/* <div className="reply staff">
          <div className="reply-left">
            <b>Tabassum Shabbir</b>
            <span className="badge staff">Staff</span>
          </div>
          <div className="reply-right">
            <small>Posted on: Jan 28, 2026 11:05 PM</small>
            <p>
              Thank you for bringing this to our attention.
              <br />
              <br />
              We have reviewed the issue regarding the <b>403 Forbidden</b>{" "}
              error while downloading PDFs. Our technical team is currently
              investigating the cause, and well update you as soon as we have
              more information.
              <br />
              <br />
